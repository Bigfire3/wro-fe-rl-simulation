        ...
        for episode in range(3):
            ...
            while not done:
                ...
                if step % 10 == 0:
                    ...
                    print(f"          Obs (v_x, steer, inn40, inn100, out40, out100, corner_x, corner_y): "
                          f"{obs[0]:.2f}, {obs[1]:.2f}, {obs[2]:.2f}, {obs[3]:.2f}, {obs[4]:.2f}, {obs[5]:.2f}, {obs[6]:.2f}, {obs[7]:.2f}")
                    print(f"          Obs (obs1_x, obs1_y, obs1_c, obs2_x, obs2_y, obs2_c): "
                          f"{obs[8]:.2f}, {obs[9]:.2f}, {obs[10]:.1f}, {obs[11]:.2f}, {obs[12]:.2f}, {obs[13]:.1f}")
