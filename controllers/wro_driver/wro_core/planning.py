...
def compute_observation_vector(pose, obstacles, driving_direction, smoothed_steering, ego_v_x):
    ...
    Returns:
        ...
        p_30 (np.ndarray): Coordinates of the 30cm lookahead point.
        p_60 (np.ndarray): Coordinates of the 60cm lookahead point.
    """
    rx, ry, ryaw = pose
    ...
    p_30 = geometry.get_point_at_s(s_30, driving_direction)
    
    s_60 = (s_current + 0.6) % 8.0
    p_60 = geometry.get_point_at_s(s_60, driving_direction)
